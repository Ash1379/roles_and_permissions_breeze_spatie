...
class TaxController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:view tax', only: ['index']),
            new Middleware('permission:edit tax', only: ['edit','update']),
            new Middleware('permission:create tax', only: ['create','store']),
            new Middleware('permission:delete tax', only: ['destroy']),
        ];
    }
