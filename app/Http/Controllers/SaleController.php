...
class SaleController extends Controller implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            ...
            new Middleware('permission:edit sale', only: ['edit','update']),
            new Middleware('permission:create sale', only: ['create','store']),
            new Middleware('permission:delete sale', only: ['destroy']),
        ];
    }
    /**
