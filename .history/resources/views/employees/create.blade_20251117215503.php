...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-xxl py-3 d-flex justify-content-between align-items-center">
            <h2 class="fw-semibold fs-4 text-dark m-0">Employees / Create</h2>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('employees.store') }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="position" class="form-control w-50" value="{{ old('position') }}">
                                    @error('position')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="salary" class="form-control w-50" value="{{ old('salary') }}">
                                    @error('salary')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
