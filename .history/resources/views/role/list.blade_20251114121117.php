  ...
  <table class="w-full">
            ...
            <tbody class="bg-gray-50">
                ...
                <tr class="border-b hover:bg-gray-100">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('roles.edit',$role->id) }}" class="bg-slate-700 text-sm rounded-md text-white px-5 py-3 hover:bg-slate-600">Edit</a>
                        <a href="javascript:void(0);" onclick="deletePermission({{ $role->id }})" class="bg-red-500 text-sm rounded-md text-white px-5 py-3 hover:bg-red-400">Delete</a>
                    </td>
                </tr>
                @endforeach
                @endif
