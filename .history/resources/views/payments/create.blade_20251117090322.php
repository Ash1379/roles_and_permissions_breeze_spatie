                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('payments.store') }}" method="post">
                        ...
                        <div class="my-3">
                            ...
                            <input type="text" name="method" value="{{ old('method') }}" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg">
                            @error('method')<p class="text-red-500 font-medium">{{ $message }}</p>@enderror
                        </div>

                        <div class="my-3">
                            <label class="text-sm font-medium">Date</label>
                            <input type="date" name="date" value="{{ old('date') }}" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg">
