                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('employees.store') }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="position" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" value="{{ old('position') }}">
                            @error('position')<p class="text-red-500 font-medium">{{ $message }}</p>@enderror
                        </div>

                        <div class="mb-4">
                            <label class="text-sm font-medium">Salary</label>
                            <input type="number" step="0.01" name="salary" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" value="{{ old('salary') }}">
