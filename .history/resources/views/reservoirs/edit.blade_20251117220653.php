...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-xxl py-3 d-flex justify-content-between align-items-center">
            <h2 class="fw-semibold fs-4 text-dark m-0">Edit Reservoir</h2>
                        ...
                        <div class="card-body">
                            <form action="{{ route('reservoirs.update',$reservoir->id) }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control w-50" value="{{ old('name', $reservoir->name) }}">
                                    @error('name')<p class="text-danger mt-1">{{ $message }}</p>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Location</label>
                                    <input type="text" name="location" class="form-control w-50" value="{{ old('location', $reservoir->location) }}">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Capacity</label>
                                    <input type="number" name="capacity" class="form-control w-50" value="{{ old('capacity', $reservoir->capacity) }}">
