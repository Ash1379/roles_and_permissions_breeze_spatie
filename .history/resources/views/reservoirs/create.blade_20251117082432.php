                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('reservoirs.store') }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="location" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" value="{{ old('location') }}">
                        </div>

                        <div class="mb-4">
                            <label class="text-sm font-medium">Capacity</label>
                            <input type="number" name="capacity" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" value="{{ old('capacity') }}">
