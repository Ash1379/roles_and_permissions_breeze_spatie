            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                            ...
                            <div class="my-3">
                                <input value="{{ old('title ') }}" type="text" name="title" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" placeholder="Title ">
                                @error('title')
                            ...
                            <div class="my-3">
                                <textarea name="text" id="text" placeholder="Content"  class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" rows="10" cols="20">{{ old('text') }}</textarea>
                            </div>
