            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                            ...
                            <div class="my-3">
                                <input value="{{ old('title',$article->title) }}" type="text" name="title" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" placeholder="Title ">
                                @error('title')
                            ...
                            <div class="my-3">
                                <input value="{{ old('author',$article->author) }}" type="text" name="author" class="border-gray-300 text-black shadow-sm w-1/2 rounded-lg" placeholder="author">
                                @error('author')
                                <p class="text-red-500 font-medium" >{{ $message }}</p>
                                @enderror
                            </div>
