                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebarAccountant">
                                <ul class="nav-second-level">
                                    ...
                                    {{-- Reservoirs --}}
                                    <li><a href="{{ route('reservoirs.index') }}">All Reservoirs</a></li>
                                    ...
                                    {{-- Imports --}}
                                    <li><a href="{{ route('imports.index') }}">All Imports</a></li>
                                    ...
                                    {{-- Lends --}}
                                    <li><a href="{{ route('lends.index') }}">All Lends</a></li>
