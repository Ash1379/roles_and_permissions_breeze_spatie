                ...
                <tr class="border-b hover:bg-gray-100">
                    ...
                    <td class="px-6 py-4 ">
                     ...
                     <td class="px-6 py-4">
                        ...
                        <a href="javascript:void(0);" onclick="deleteRole({{ $role->id }})" class="bg-red-500 text-sm rounded-md text-white px-5 py-3 hover:bg-red-400">Delete</a>
                    </td>
