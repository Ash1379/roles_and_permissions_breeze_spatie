...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-xxl py-3 d-flex justify-content-between align-items-center">
            <h2 class="fw-semibold fs-4 text-dark m-0">{{ $title }}</h2>
            <a href="{{ $createRoute }}" class="btn btn-primary btn-sm">Create</a>
        </div>
        <!-- End Header -->
                                ...
                                <tbody>
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            @endforeach
                                            <td>
                                                <a href="{{ route($editRoute, $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
