...
class PermissionController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:view permission', ['index']),
            new Middleware('permission:edit permission', ['edit']),
            new Middleware('permission:create permission', ['create','store']),
            new Middleware('permission:delete permission', ['destroy']),
        ];
    }
