...
class PermissionController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:view Article', ['index']),
            new Middleware('permission:edit Article', ['edit']),
            new Middleware('permission:create Article', ['create','store']),
            new Middleware('permission:delete Article', ['destroy']),
        ];
    }
