...
class PermissionController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware(middleware: 'permission:view permissions', only: ['index']),
            new Middleware(middleware: 'permission:edit permissions', only: ['edit']),
            new Middleware(middleware: 'permission:create permissions', only: ['create','store']),
            new Middleware(middleware: 'permission:delete permissions', only: ['destroy']),
        ];
    }
