...
Route::get('expenses', 'index')->name('expenses.index');                 // لیست
    Route::get('expenses/create', 'create')->name('expenses.create');       // فرم ایجاد
    Route::post('expenses/store', 'store')->name('expenses.store');          // ذخیره جدید
    Route::get('expenses/edit/{id}', 'edit')->name('expenses.edit');         // فرم ویرایش
    Route::post('expenses/update/{id}', 'update')->name('expenses.update');  // بروزرسانی
    Route::get('expenses/', 'destroy')->name('expenses.destroy');
    });
